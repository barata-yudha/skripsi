                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="row g-3 needs-validation myForm" method="POST"
                                    action="{{ route('dashboard.ont.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="col-md-4">
                                        <label class="form-label">Merk ONT</label>
                                        <input type="text" class="form-control" name="merk_ont" value="{{ old('merk_ont') }}" required="">
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label">Type ONT</label>
                                        <input type="text" class="form-control" name="type_ont" value="{{ old('type_ont') }}" required="">
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label">Versi ONT</label>
                                        <input type="text" class="form-control" name="versi_ont" value="{{ old('versi_ont') }}" required="">
                                    </div>
