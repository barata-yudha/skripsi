...
class TimeslotSolveDataTable extends DataTable
{
    /**
    ...
    {
        return $model->with(['customer'])->where('status', 'finished')->newQuery();
    }
    ...
    {
        return $this->builder()
                    ->setTableId('TimeslotFinisheddatatable-table')
    ...
    {
        return 'TimeslotFinished_' . date('YmdHis');
    }
}
